      ...
      <div className="container mx-auto px-4 pt-16 pb-12 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 max-w-lg mx-auto">
          <Link to="/chat" className="flex-1">
            <Button size="lg" className="w-full text-base px-6 py-3 h-auto bg-primary hover:bg-primary/90">
              Start Your Career Journey
            </Button>
          </Link>
          <Button variant="outline" size="lg" className="flex-1 text-base px-6 py-3 h-auto border-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <Card className="p-6 text-center bg-card/80 backdrop-blur border-border/50">
            <div className="text-3xl font-bold text-primary mb-1">100K+</div>
            <div className="text-sm text-muted-foreground">AI Career Matches</div>
          </Card>
          <Card className="p-6 text-center bg-card/80 backdrop-blur border-border/50">
